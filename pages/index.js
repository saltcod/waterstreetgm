				...
				<div className="container px-4 mx-auto">
					...
					<div className="layout-row md:flex mb-24 md:mb-48">
						...
						<div className="md:w-3/4">
							<p className="text-xl md:text-3xl font-semibold mb-8">
								...
								<a className="underline hover:shadow-md" href="https://10up.com/our-work/">
									here
								</a>
								.
							</p>
							...
							<p className="text-xl">
								...
								<a href="https://github.com/saltcod/timezoner" className="underline hover:shadow-md">
									timezone converter
								</a>{' '}
								to help coordinate meetings with international team members, a{' '}
								<a className="underline hover:shadow-md" href="http://at-the-lights.netlify.app">
									shopping list
								</a>{' '}
								app that works precisely how I want it to, and I'm currently working on a
								live-searchable index of the{' '}
								<a className="underline hover:shadow-md" href="https://www.nlaa.ca/tely10/">
									Tely 10
								</a>
					...
					<div className="layout-row md:flex mb-24 md:mb-48">
						...
						<div className="md:w-3/4">
							<p className="text-xl md:text-3xl font-semibold mb-4">
								A nod to one of my favourite sites,{' '}
								<a href="https://usesthis.com/" className="underline hover:shadow-md">
									Uses This
								</a>
							</p>

							<p className="text-xl mb-8">A bunch of things I use to get all the things done:</p>

							<ul>
								<li>
									<a
										className="underline hover:shadow-md"
										href="https://everymac.com/systems/apple/mac_mini/specs/mac-mini-core-i7-3.2-late-2018-specs.html"
									>
										Mac Mini, i7, Late 2018.
									</a>{' '}
									Mostly fine but the constant fan noise drives me insane. Anxiously awaiting M1x
									chips for an upgrade.
								</li>
								<li>
									<a
										className="underline hover:shadow-md"
										href="https://www.amazon.ca/Logitech-Gaming-Advanced-Sensor-Competitive/dp/B01JPOLLTK"
									>
										Logitech G mouse
									</a>
									. Good sensor/FPS number, nice and light.
								</li>
								<li>
									<a
										className="underline hover:shadow-md"
										href="https://www.dell.com/en-ca/shop/dell-ultrasharp-27-monitor-u2719d/apd/210-arcv/monitors-monitor-accessories"
									>
										Dell U2719D monitor
									</a>
									. Mostly terrible.
								...
								<li>
									...
									. Better at just about everything than my brand new iPhone.
								</li>
								<li>
									<a className="underline hover:shadow-md" href="https://www.apple.com/ca/iphone-12/">
										iPhone 12 Mini
									</a>
									. The perfect sized phone.
								</li>
								<li>
									<a
										className="underline hover:shadow-md"
										href="https://arcteryx.com/ca/en/shop/mens/sawyer-coat"
									>
								...
								<li>
									<a className="underline hover:shadow-md" href="https://www.geekdesk.com/">
										Stand-up desk
									</a>
									. I use this next to a treadmill, so I can work and work at the same time.
								</li>
							</ul>
						</div>
					</div>
					...
					<div className="layout-row md:flex mb-48">
						...
						<div className="md:w-3/4">
							...
							<p className="text-xl mb-8">
								Here's a quick list of some of the things I'm reading, listening to, using, or otherwise
								"into" at the moment:
							</p>
							...
							<ul>
								<li>
									<a
										className="underline hover:shadow-md hover:shadow-md"
								...
								<li>
									<a
										className="underline hover:shadow-md"
										href="https://www.loveandlemons.com/cookbook/"
									>
								...
								<li>
									<a
										className="underline hover:shadow-md"
										href="https://daringfireball.net/2020/05/dithering"
									>
										Dithering Podcast
									</a>
								</li>
								...
								<li>
									<a
										className="underline hover:shadow-md"
										href="https://www.courtneymarieandrews.com/"
									>
								...
								<li>
									<a
										className="underline hover:shadow-md"
										href="http://www.wumb.org/listenlive/listen.php"
									>
										WUMB
									</a>
								</li>
